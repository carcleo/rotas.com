<html>
    <head>
        ...
        <title><?php echo title() . ' ' . ($subtTitle ?? ""); ?></title>

        <link type="image/x-png" rel="shortcut icon" href="<?php echo assets("imgs/favicon.png"); ?>">
    ...
    <body>
        ...
        <section class='footer'>
            ...
            <?php require_once(dirname(__DIR__,2) . "/mvc/views/site/footer.php"); ?>

        </section>	
        
        <section class='base'>

            <?php require_once(dirname(__DIR__,2) . "/mvc/views/site/base.php"); ?>
